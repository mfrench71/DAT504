...
{
queryMysql("INSERT INTO users
(username, password, firstname, lastname, timeBalance, creditBalance)
VALUES('$username', '$password', '$firstname', '$lastname','0','1')");
...
<input type='text' maxlength='255' name='firstname'
value='$firstname'><br>

<span class='fieldname'>Last Name</span>
<input type='text' maxlength='255' name='lastname'
value='$lastname'><br>
